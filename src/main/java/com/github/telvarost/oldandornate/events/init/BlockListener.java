...
public class BlockListener {
    ...
    public void registerBlocks(BlockRegistryEvent event) {
        ...
        DUNGEON_PLATFORM   = new DungeonPlatform  (Identifier.of(ModHelper.NAMESPACE, "dungeon_platform"), Material.STONE).setHardness(10.0F).setResistance(2000.0F).setSoundGroup(STONE_SOUND_GROUP).setTranslationKey(ModHelper.NAMESPACE, "dungeon_platform");
        FALTERING_PLATFORM = new FalteringPlatform(Identifier.of(ModHelper.NAMESPACE, "faltering_platform"), Material.STONE).setHardness(1.0F).setResistance(200.0F).setSoundGroup(STONE_SOUND_GROUP).setTranslationKey(ModHelper.NAMESPACE, "faltering_platform");
        GHOST_PLATFORM     = new GhostPlatform    (Identifier.of(ModHelper.NAMESPACE, "ghost_platform"), Material.STONE).setHardness(0.1F).setResistance(20.0F).setSoundGroup(STONE_SOUND_GROUP).setTranslationKey(ModHelper.NAMESPACE, "ghost_platform");
